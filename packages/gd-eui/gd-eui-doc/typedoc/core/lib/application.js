 ...
 */
let Application = (Application_1 = class Application extends (
  ...
  convert() {
    ...
    const errors = (0, array_1.flatMap)(
      [...programs],
  ...
  convertAndWatch(success) {
    ...
    if (
      ...
      (_b = (_a = ts.sys).clearScreen) === null || _b === void 0
        ? void 0
        : _b.call(_a);
    }
    this.logger.verbose(
    ...
    const tsconfigFile =
      (_c = index_2.TSConfigReader.findConfigFile(
        this.options.getValue("tsconfig")
      )) !== null && _c !== void 0
        ? _c
        : "tsconfig.json";
    ...
    const runSuccess = () => {
      ...
      if (successFinished) {
        ...
        const entryPoints = (0, entry_point_1.getWatchEntryPoints)(
          this.logger,
          this.options,
          currentProgram
        );
    ...
    host.afterProgramCreate = (program) => {
      ...
      origAfterProgramCreate === null || origAfterProgramCreate === void 0
        ? void 0
  ...
  async generateDocs(project, out) {
    ...
    if (this.logger.hasErrors()) {
      ...
      this.logger.info(
        `Documentation generated at ${(0, paths_1.nicePath)(out)}`
      );
