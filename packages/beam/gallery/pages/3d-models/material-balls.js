...
pointLights.set('u_Lights[0].direction', [1, 1, 1]).set('u_Lights[0].strength', 1);
...
const base = '../../assets/';
Promise.all([loadEnvMaps(base + 'ibl/helipad'), loadImages(base + 'ibl/brdfLUT.png')]).then(
    ([[diffuseState, specularState], [brdf]]) => {
