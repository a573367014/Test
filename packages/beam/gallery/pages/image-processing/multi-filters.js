...
import { BrightnessContrast, HueSaturation, Vignette } from '../../plugins/image-filter-plugins.js';
import { createRect } from '../../utils/graphics-utils.js';
import { loadImages } from '../../utils/image-loader.js';

const { DataBuffers, IndexBuffer, Textures, Uniforms, OffscreenTarget } = ResourceTypes;
...
const quadBuffers = [beam.resource(DataBuffers, quad.data), beam.resource(IndexBuffer, quad.index)];
...
const offscreenTargets = [beam.resource(OffscreenTarget), beam.resource(OffscreenTarget)];
