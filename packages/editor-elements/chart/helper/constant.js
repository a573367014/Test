 ...
 * chart关键的model字段
 */
export const CHART_MODEL_MAIN_PROP = [
    'type', // 类型
...
const createProps = (prefix, props) => {
    if (props.length === 0) return prefix;
    return props.map((i) => prefix + i);
};
 ...
 * TODO: 未来其他字段开放后需要增加
 */
export const SWITCH_PROP = [
    'chartTitle.enable',
    'chartTitle.text',
    'chartTitle.position',
    'chartTitle.fontSize',
    'chartTitle.color',
    // 'chartTitle.fontWeight',
    ...
    // X坐标轴
    ...createProps('xAxis', axisProps),
    ...createProps('yAxis', axisProps),
    ...createProps('y2Axis', axisProps),
    // 'xAxis.enbale',
    // 'xAxis.title.enable',
    // 'xAxis.title.text',
