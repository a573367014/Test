...
exports.crosshairUrl = exports.ShapeCursorPreset = exports.CommonCursorPreset = void 0;

var _utils = require("./utils");

const crosshairUrl = 'https://cdn.dancf.com/fe-assets/img/6f798e5b13603b87580740d0395d6136.svg';
exports.crosshairUrl = crosshairUrl;
const CommonCursorPreset = {
  default: {
...
exports.CommonCursorPreset = CommonCursorPreset;
const ShapeCursorPreset = {
  rect: {
    image: props => (0, _utils.genSvgUrl)('https://cdn.dancf.com/fe-assets/img/8366aa2acd4ca7701da22c5514126df9.svg', [props.fill, props.stroke]),
    top: 16,
    left: 16,
    replacement: 'crosshair'
  },
  arrow: {
    image: props => (0, _utils.genSvgUrl)('https://cdn.dancf.com/fe-assets/img/f5f4269784a88570d4ce8e2624c835fe.svg', [props.fill, props.stroke]),
    top: 16,
    left: 16,
    replacement: 'crosshair'
  },
  ellipse: {
    image: props => (0, _utils.genSvgUrl)('https://cdn.dancf.com/fe-assets/img/ec21a1d223fc1979098b2ff56fd35e56.svg', [props.stroke, props.fill]),
    top: 16,
    left: 16,
    replacement: 'crosshair'
  },
  triangle: {
    image: props => (0, _utils.genSvgUrl)('https://cdn.dancf.com/fe-assets/img/db0dd2670d9ec35e74cbf3a0a85eadc7.svg', [props.fill, props.stroke]),
    top: 16,
    left: 16,
    replacement: 'crosshair'
  },
  line: {
    image: props => (0, _utils.genSvgUrl)('https://cdn.dancf.com/fe-assets/img/2df66e8e2c1c227434af07c87e25fdd9.svg', [props.stroke, props.fill]),
    top: 16,
    left: 16,
    replacement: 'crosshair'
  },
  brush: {
    image: props => (0, _utils.genSvgUrl)('https://cdn.dancf.com/fe-assets/img/6660fb88273018b504da31c1e109f0e1.svg', [props.stroke, props.fill]),
    top: 16,
    left: 16,
    replacement: 'crosshair'
  },
  ...
  mosaicBrush: {
    image: props => {
      ...
      const svg = (0, _utils.genSvgUrl)('https://cdn.dancf.com/fe-assets/img/0f56335bbdfb75be6f3e70b9d095612f.svg', [String(scale)]);
      return svg;
    },
    top: 16,
    left: 16,
...
exports.ShapeCursorPreset = ShapeCursorPreset;